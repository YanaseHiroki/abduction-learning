...
const options = {
  ...
  miniflare: {
    ...
    bindings: { PROVIDER_API_KEY: "test-key", RESEND_API_KEY: "test-resend-key", FEEDBACK_TO: "owner@example.com", KOFI_VERIFICATION_TOKEN: "test-kofi-token", SPONSORS_WEBHOOK_SECRET: "test-github-secret" },
  },
};
