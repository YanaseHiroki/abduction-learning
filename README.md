...
画面ではこれらの用語は使わず、案内役が語りかけるセリフ調で「例文 → 見比べる → 仮説 → 訳して確かめる → まとめ」と進みます。本を読んでいなくても使えます。

続ける仕掛け: 探究を始めたりカードを進めたりするとポイントが入り、レベルが上がります。日ごとの連続記録（ストリーク）もホームに出ます。どちらも保存したデータから計算するので、バックアップと一緒に移ります。
