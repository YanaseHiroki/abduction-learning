...
- 全体: 1日 330 つ — 運営者の上限額を固定する安全弁。1日 $3 の予算から決めている
  - 2026-09 のベンチマーク価格（docs/model-bench-2026-09.md）では探究1つが平均 $0.009（例文セット3回＋翻訳テスト5回）なので、$3 ÷ $0.009 ≒ 333 を切り下げて 330（1日 約$2.97）
  - これは平均で、最悪の場合ではない。330 件すべてが 60 回を高い方の呼び出しで使い切ると（1件 $0.156）1日 約$51 になりうる
